...
export function ShareButton({ slug, title, locale, variant }: ShareButtonProps) {
  ...
  function handleWhatsApp() {
    openPopup(`https://wa.me/?text=${encodeURIComponent(title + " " + getUrl())}`);
  }
  ...
  function handleFacebook() {
    openPopup(`https://facebook.com/sharer/sharer.php?u=${encodeURIComponent(getUrl())}`);
  }

  function handleTwitter() {
    openPopup(`https://x.com/intent/tweet?text=${encodeURIComponent(title)}&url=${encodeURIComponent(getUrl())}`);
  }

  function handleTelegram() {
    openPopup(`https://t.me/share/url?url=${encodeURIComponent(getUrl())}&text=${encodeURIComponent(title)}`);
  }
