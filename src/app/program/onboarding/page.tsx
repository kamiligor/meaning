...
function OnboardingHeader() {
  return (
    <header className="border-b border-[#e2e7eb] bg-white">
      <nav className="max-w-5xl mx-auto px-5 md:px-8 h-14 flex items-center gap-4">
        <a
          href="/"
          className="flex flex-col items-start group shrink-0"
          aria-label="just have a little meaning — home"
        >
          <span className="text-sm font-extrabold text-[#1E2A36] leading-none tracking-tight group-hover:text-[#2d3f4e] transition-colors duration-200" style={logoStyle}>just</span>
          <span className="text-[7px] italic text-[#8A99A8] leading-none mt-[3px] tracking-wide" style={logoStyle}>have a little</span>
          <span className="text-sm font-extrabold text-[#7B9E8C] leading-none mt-[3px] tracking-tight group-hover:text-[#6a8d7b] transition-colors duration-200" style={logoStyle}>meaning</span>
        </a>
