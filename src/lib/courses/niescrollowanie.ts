  ...
  days: [
    {
      ...
      title: "Stan domyślny",
      knowledge: [
        "Przypomnij sobie moment tuż po przebudzeniu, zanim ręka sięgnie po telefon. Głowa sama z siebie już coś robi: przelatuje po wczorajszej rozmowie, planuje dzień, wraca do sprawy sprzed tygodnia. To nie jest szum. To stan domyślny mózgu, tryb, w który wchodzi zawsze, kiedy nie dostaje zadania z zewnątrz. W tym trybie porządkuje wspomnienia, planuje przyszłość i, jak podkreśla Arthur Brooks, profesor Harvardu, który latami bada, co robi ludzi szczęśliwymi, jako jedyny zadaje pytania o to, co ważne. Nuda to nie brak aktywności mózgu. To jego własna praca, ta, której nie da się zlecić nikomu innemu.",
