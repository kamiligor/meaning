...
const dict = {
  en: {
    ...
    readNext: "Read next",
    navStandards: "How this is written",
    newsletterHeading: "Stay curious",
    newsletterSubtext: "Get new psychology insights delivered to your inbox. No spam, just meaning. Some e-mails follow what you read and which courses you take.",
    ...
    accountExportHint: "Everything we hold about you, as a JSON file.",
    accountDeleteTitle: "Delete account",
    accountDeleteIntro: "This removes your account, your program texts and progress, your saved posts and your comments. It cannot be undone.",
    accountDeleteExportFirst: "Export your data first if you want to keep a copy.",
    accountDeleteKeepComments: "Leave my comments published, signed \"Deleted user\"",
    accountDeleteKeepCommentsNote: "They stay publicly visible under the posts. You can still write to us later and ask for them to be removed.",
    accountDeleteConfirmWord: "DELETE",
    accountDeleteConfirmLabel: "Type DELETE to confirm",
    accountDeleteStart: "Delete my account",
    accountDeleteConfirm: "Delete permanently",
    accountDeleteCancel: "Cancel",
    accountDeleting: "Deleting…",
    accountDeleteError: "Could not delete the account. Try again.",
    like: "Like",
    unlike: "Unlike",
    favorites: "Favorites",
    ...
    displayNameTaken: "Somebody already goes by that name.",
    displayNameReserved: "That name cannot be used.",
    displayNameCooldown: "A name can be changed once a day.",
    displayNameNextChange: "You can change it again in",
    displayNameHours: "h",
    displayNameMinutes: "min",
    ...
    commentsReported: "Reported. Thank you.",
    commentsReportTitle: "Why are you reporting this?",
    commentsReportNote: "Anything to add? (optional)",
    commentsReportSend: "Send report",
    commentsBanned: "You can no longer comment.",
    reportSpam: "Spam or advertising",
    reportHarassment: "Abuse or harassment",
    reportSelfHarm: "Someone may be in danger",
    reportMisinformation: "Harmful misinformation",
  ...
  pl: {
    ...
    readNext: "Przeczytaj dalej",
    navStandards: "Jak to powstaje",
    newsletterHeading: "Bądź na bieżąco",
    newsletterSubtext: "Nowe spostrzeżenia z psychologii prosto na Twoją skrzynkę. Bez spamu, tylko to, co ma znaczenie. Część maili dobieramy do tego, co czytasz i które kursy przechodzisz.",
    ...
    accountExportHint: "Wszystko, co o tobie przechowujemy, w pliku JSON.",
    accountDeleteTitle: "Usuń konto",
    accountDeleteIntro: "Usuwamy konto, twoje teksty i postępy w programie, zapisane posty oraz komentarze. Tego nie da się cofnąć.",
    accountDeleteExportFirst: "Jeśli chcesz zachować kopię, najpierw wyeksportuj dane.",
    accountDeleteKeepComments: "Zostawcie moje komentarze, podpisane „Użytkownik usunięty”",
    accountDeleteKeepCommentsNote: "Zostaną publicznie widoczne pod postami. Możesz później napisać do nas i poprosić o ich usunięcie.",
    accountDeleteConfirmWord: "USUŃ",
    accountDeleteConfirmLabel: "Wpisz USUŃ, żeby potwierdzić",
    accountDeleteStart: "Usuń moje konto",
    accountDeleteConfirm: "Usuń bezpowrotnie",
    accountDeleteCancel: "Anuluj",
    accountDeleting: "Usuwanie…",
    ...
    displayNameReserved: "Tej nazwy nie można użyć.",
    displayNameCooldown: "Nazwę można zmienić raz na dobę.",
    displayNameNextChange: "Kolejna zmiana możliwa za",
    displayNameHours: "godz.",
    displayNameMinutes: "min",
    ...
    commentsReport: "Zgłoś",
    commentsReported: "Zgłoszone. Dziękujemy.",
    commentsReportTitle: "Dlaczego zgłaszasz ten komentarz?",
    commentsReportNote: "Chcesz coś dodać? (opcjonalnie)",
    commentsReportSend: "Wyślij zgłoszenie",
    commentsBanned: "Nie możesz już komentować.",
    reportSpam: "Spam albo reklama",
    reportHarassment: "Napaść albo obrażanie",
    reportSelfHarm: "Ktoś może być w niebezpieczeństwie",
    reportMisinformation: "Szkodliwa nieprawda",
    reportOther: "Coś innego",
