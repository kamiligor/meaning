---
slug: sadness-is-not-a-malfunction
status: published
locale: en
...
headline: "{Sadness} Is Not a Malfunction"
...
Low mood slows you down and turns your attention {inward}. This is not a fault. It is a signal that something {needs attention}.

Sometimes it is about something you neglected. Sometimes it is about something someone did to you. In both cases sadness says the same thing: {there is something important here}, do not walk past it.

<!-- slide-only -->
## What question to ask yourself

If sadness comes {from within}: what am I ignoring? What do I need that I am not giving myself?

If it comes {from outside}, because someone hurt you: why does this sting so much? What does it say about this {relationship}? Where is the boundary that was crossed?

The question itself shifts your perspective. Instead of a problem to fix you see {information to read}.
...
Sadness is not a sign that something is wrong with you. It is a signal that something in your life needs attention.

Sometimes sadness comes from within: you neglected something important, you are acting against yourself, you are ignoring a need. Sometimes it comes from outside: someone said something hurtful, crossed a boundary, dismissed what matters to you.

In both cases sadness carries information. The question is what to ask yourself:
→ sadness from within: what am I ignoring? What do I need?
→ sadness from outside: why does this sting so much? What does it say about this relationship?
→ in both: is there a boundary I need to set?
→ in both: what can I do about it?

You do not have to like sadness. But it is worth taking it seriously instead of drowning it out. The answer to these questions is often surprisingly specific.

#psychology #emotions #sadness #mentalhealth #lifehacks #mood #selfawareness #emotionalintelligence #wellness #justhavealittlemeaning
