---
slug: confidence-is-built-by-doing
status: published
locale: en
...
headline: "{Confidence} Is Built by Doing"
...
When you lack confidence, you {do not act}. But it is action itself that builds confidence. Without it you stay in place and the belief "{I cannot do this}" solidifies.

Psychologist Albert Bandura called these {mastery experiences}. You do something hard, you come out intact, and you are left with a conviction: I can.

<!-- slide-only -->
## Confidence is specific

You can be confident {at work} and completely unsure of yourself {in relationships}. It is not one trait that you either have or do not.

That is why affirmations do not work. Confidence is built through experience, {in the specific domain} where you need it.
...
Confidence is not a starting point. It is a result of experiences in which you handled something difficult.

Psychologist Albert Bandura studied this for decades. He identified four sources of confidence, one of which is by far the strongest: the personal experience of handling something hard.

Bandura's four sources of confidence:
→ mastery experience: you did something hard and handled it
→ observing others: you see someone like you succeeding at what scares you
→ specific feedback: someone you respect tells you concretely what you do well
→ body state: rested and recovered, you interpret tension differently than when exhausted

What matters: confidence is not one trait. It is tied to specific domains. You can be confident at work and unsure in relationships. That is why general affirmations do not work. Confidence is built through experience in the specific domain where you need it.

#psychology #confidence #action #mentalhealth #lifehacks #bandura #growth #selfefficacy #selfworth #justhavealittlemeaning

#psychology #confidence #action #mentalhealth #lifehacks #courage #motivation #fear #growth #justhavealittlemeaning
