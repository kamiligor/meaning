---
slug: the-ending-rewrites-the-story
status: published
locale: en
...
headline: "The {Ending} Rewrites the Story"
...
A difficult relationship that ended in reconciliation stays in memory differently from one that {ended in silence}. The same years, the same events, but a different ending changes the {meaning of the entire story}.

Your brain does not evaluate experiences by their average. It evaluates them by {how they ended}.

<!-- slide-only -->
## It works both ways

Good memories can be {poisoned} by a bad ending. A years-long friendship that ended in betrayal becomes "fake from the start" in memory, even though for years it {was real}.

But this means something important: if you can give difficult experiences a {good ending}, you change the way you remember them.
...
Your brain does not evaluate experiences by their average. It evaluates them by two moments: the most intense point and the ending. Daniel Kahneman called this the peak-end rule.

That is why the same experience changes meaning depending on how it ends. A difficult relationship that ends in reconciliation stays as a lesson. One that ends in silence stays as a wound.

Psychologist Dan McAdams found two narrative patterns:
→ redemption stories: start badly, end well = greater resilience, more meaning
→ contamination stories: start well, end badly = more depression, even with good circumstances

You cannot change what happened. But you have influence over the ending. And the ending rewrites the story.

#psychology #narrative #meaning #mentalhealth #lifehacks #memories #therapy #kahneman #purpose #justhavealittlemeaning
