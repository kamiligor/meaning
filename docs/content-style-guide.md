...
Cel: **edukować w przystępny sposób**. Czytelnik powinien czuć, że rozmawia z kimś kompetentnym, ale nie ze suchym podręcznikiem ani z kolegą z baru.
...
- Unikaj zdań dłuższych niż 2 linie
...
- [ ] Czy każde zdanie jest zrozumiałe bez kontekstu naukowego?
- [ ] Czy nie ma slangowych wyrażeń ("zmienia grę", "totalnie", "hack")?
- [ ] Czy metafory są subtelne i pomagają zrozumieć, a nie dramatyzują?
- [ ] Czy terminy naukowe są wyjaśnione natychmiast po użyciu?
- [ ] Czy ton jest ciepły, ale nie infantylny?
- [ ] Czy czytelnik po przeczytaniu wie, co konkretnie zrobić?
